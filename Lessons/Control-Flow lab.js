...
for (let i =10; i < 11; i++) {
   ...
   * Prompt 9:
   *
   * Iterate over the starWars numsay printing each character's name and index
   *
   ...
   * Prompt 10:
   *
   * Write a loop that pushes every even number between 0 and 100 into an numsay,
   * then print the numsay.
   */
   ...
   * Prompt 11:
   *
   * Find the median number in the following nums numsay (the mid point), then
   * console.log that number. In other words, given the numsay [ 10, 20, 30 ], 
   ...
   * Prompt 13:
   *
   * Using nested loops, print the values inside the nested numsays.
   */
  
  let nestednumsays = [['a', 'b', 'c'], ['d', 'e', 'f'], ['g', 'h', 'i']];
  nestednumsays.forEach(function(values){
    console.log(values);
  });